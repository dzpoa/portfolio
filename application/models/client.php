...
class Client extends DataMapper {
	...
	var $has_one = array(
						'firm' => array(
				            'class' => 'firm',
				            'other_field' => 'client' // in the FIRM model, this defines the array key used to identify this relationship
				        ),
				        'project' => array(
				            'class' => 'project',
				            'other_field' => 'client' // in the PROJECT model, this defines the array key used to identify this relationship
				        ),
	);
