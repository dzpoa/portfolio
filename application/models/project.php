...
class Project extends DataMapper {
	...
	var $has_one = array(
						'client' => array(
				            'class' => 'client',
				            'other_field' => 'project' // in the CLIENT model, this defines the array key used to identify this relationship
				        ),
	);
	...
	var $has_many = array(
							'technology' => array(
								'class' => 'technology',
								'other_field' => 'project', // in the TECHNOLOGY model, this defines the array key used to identify this relationship
								'join_table' => 'project_has_technology',
								'join_self_as' => 'project',
								'join_other_as' => 'technology',
								'reciprocal' => TRUE
							)
	...
	var $validation = array(
		...
		'description' => array(
			'rules' => array('max_length' => 25000),
			'label' => 'Description'
		),
		'year' => array(
			'rules' => array('required', 'min_length' => 4, 'max_length' => 4),
			'label' => 'Year'
		)
	);
