 ...
 */
class Technology extends DataMapper {
	...
	var $has_one = array(
						'category' => array(
				            'class' => 'category',
				            'other_field' => 'technology' // in the CATEGORY model, this defines the array key used to identify this relationship
				        )
	);
	...
	var $has_many = array(
						'project' => array(
								'class' => 'project',
								'other_field' => 'technology', // in the PROJECT model, this defines the array key used to identify this relationship
								'join_table' => 'project_has_technology',
								'join_self_as' => 'technology',
	...
	var $validation = array(
		'name' => array(
			'rules' => array('required', 'min_length' => 5, 'max_length' => 255),
			'label' => 'Name'
		)
	);
